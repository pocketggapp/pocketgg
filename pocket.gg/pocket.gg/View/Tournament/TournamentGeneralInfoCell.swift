...
final class TournamentGeneralInfoCell: UITableViewCell {
  ...
  private let cacheForLogo: Cache
  
  private let logoImageView = UIImageView(image: UIImage(named: "game-controller-square"))
  private let dateIconView = UIImageView(image: UIImage(systemName: "calendar"))
  private let locationIconView = UIImageView(image: UIImage(systemName: "mappin.and.ellipse"))
  ...
  private func setConstraints() {
    ...
    totalStackView.setEdgeConstraints(
