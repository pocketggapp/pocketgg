...
final class TournamentVC: UITableViewController {
  ...
  private let generalInfoCell: TournamentGeneralInfoCell
  private var locationCell: TournamentLocationCell?

  private var tournament: Tournament
  private var doneRequest = false
  private var requestSuccessful = true
  private var tournamentIsOnline: Bool {
    return tournament.isOnline ?? true
  }
  private let cacheForLogo: Cache
  private var tournamentIsPinned: Bool
  private var pinnedStatusChanged: Bool
