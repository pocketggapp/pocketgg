...
final class TournamentSearchVC: UITableViewController {
  ...
  private let featuredCell: UITableViewCell
  private let olderTournamentsFirstCell: UITableViewCell
  private let searchUsingEnabledGamesCell: UITableViewCell
  private let searchUsingEnabledGamesSwitch: UISwitch
