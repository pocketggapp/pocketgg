...
final class AuthTokenStepsVC: UIViewController {
  ...
  private func addLabels() {
    ...
    contentView.setEdgeConstraints(
    ...
    label2.setEdgeConstraints(
      top: label1.bottomAnchor,
      bottom: label3.topAnchor,
      leading: contentView.leadingAnchor,
      trailing: contentView.trailingAnchor,
      padding: UIEdgeInsets(top: 11, left: 11, bottom: 11, right: 11)
    )
    label3.setEdgeConstraints(
      top: label2.bottomAnchor,
      bottom: label4.topAnchor,
      leading: contentView.leadingAnchor,
      trailing: contentView.trailingAnchor,
      padding: UIEdgeInsets(top: 11, left: 11, bottom: 11, right: 11)
    )
    label4.setEdgeConstraints(
      top: label3.bottomAnchor,
