...
final class LocationVC: UITableViewController {
    ...
    var usingSpecificCountry: Bool /// Reflects whether the option to use a specific country is enabled or not.
    var usingSpecificState: Bool /// Reflects whether the option to use a specific state is enabled or not. If `canChooseState` is false, this is forced to also be false
    var choosingCountry: Bool /// Reflects whether the country picker view is currently visible or not
    var choosingState: Bool /// Reflects whether the state/province picker view is currently visible or not. If `canChooseState` is false, this is forced to also be false
    var choosingUSStates: Bool /// Distinguishes between the user selecting states in the US or Canadian provinces
    var canChooseState: Bool {
        return selectedCountry == "United States (US)" || selectedCountry == "Canada (CA)"
    }
    
    var usingSpecificCountryCell: UITableViewCell
    var countryPickerViewCell: UITableViewCell
    let countryPickerView: UIPickerView
    
    var usingSpecificStateCell: UITableViewCell
    var statePickerViewCell: UITableViewCell
    let statePickerView: UIPickerView
    let specificStateSwitch: UISwitch
    ...
    override func viewDidLoad() {
        ...
        countryPickerView.setEdgeConstraints(top: countryPickerViewCell.contentView.topAnchor,
        ...
        statePickerView.setEdgeConstraints(top: statePickerViewCell.contentView.topAnchor,
