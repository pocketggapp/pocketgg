...
final class MainVC: UITableViewController {
  ...
  private var doneRequest: [Bool]
  private var requestSuccessful: [Bool]
  private let numTournamentsToLoad: Int
  
  private var showPinned: Bool { enabledSections.contains(-1) }
  private var numSections: Int { enabledSections.count }
  private var countryCode: String
  private var addrState: String
  ...
  private var shouldReloadTournaments: Bool
    ...
    for i in 0..<numSections {
      ...
      default:
        ...
        let info = GetTournamentsByVideogamesInfo(
          perPage: numTournamentsToLoad, pageNum: 1,
          gameIDs: gameIDs,
