...
public class UserAdminTournamentsQuery: GraphQLQuery {
  public static let operationName: String = "UserAdminTournaments"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query UserAdminTournaments($id: ID, $pageNum: Int, $perPage: Int) { user(id: $id) { __typename tournaments( query: {perPage: $perPage, page: $pageNum, filter: {tournamentView: "admin"}} ) { __typename nodes { __typename id name startAt endAt isOnline city addrState countryCode images { __typename url type ratio } } } } }"#
    ))
