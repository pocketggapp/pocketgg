...
public class PhaseGroupSetsPageQuery: GraphQLQuery {
  public static let operationName: String = "PhaseGroupSetsPage"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query PhaseGroupSetsPage($id: ID, $page: Int) { phaseGroup(id: $id) { __typename sets(page: $page, perPage: 90) { __typename nodes { __typename id state round identifier fullRoundText displayScore winnerId slots { __typename prereqId entrant { __typename id name participants { __typename gamerTag } } } } } } }"#
    ))
