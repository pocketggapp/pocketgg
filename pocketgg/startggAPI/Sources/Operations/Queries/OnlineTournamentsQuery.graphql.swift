...
public class OnlineTournamentsQuery: GraphQLQuery {
  public static let operationName: String = "OnlineTournaments"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query OnlineTournaments($pageNum: Int, $perPage: Int, $gameIDs: [ID]) { tournaments( query: {perPage: $perPage, page: $pageNum, sortBy: "startAt asc", filter: {upcoming: true, hasOnlineEvents: true, videogameIds: $gameIDs}} ) { __typename nodes { __typename id name startAt endAt isOnline city addrState countryCode images { __typename url type ratio } } } }"#
    ))
