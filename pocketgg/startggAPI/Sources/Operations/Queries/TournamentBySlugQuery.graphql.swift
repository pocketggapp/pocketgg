...
public class TournamentBySlugQuery: GraphQLQuery {
  public static let operationName: String = "TournamentBySlug"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query TournamentBySlug($slug: String) { tournament(slug: $slug) { __typename id name startAt endAt isOnline city addrState countryCode images { __typename url type ratio } } }"#
    ))

  public var slug: GraphQLNullable<String>

  public init(slug: GraphQLNullable<String>) {
    self.slug = slug
  }
  ...
  public struct Data: StartggAPI.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("tournament", Tournament?.self, arguments: ["slug": .variable("slug")]),
    ] }
