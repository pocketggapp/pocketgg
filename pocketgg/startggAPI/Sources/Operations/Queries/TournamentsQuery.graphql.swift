...
public class TournamentsQuery: GraphQLQuery {
  public static let operationName: String = "Tournaments"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query Tournaments($pageNum: Int, $perPage: Int, $gameIDs: [ID]) { tournaments( query: {perPage: $perPage, page: $pageNum, sortBy: "startAt asc", filter: {upcoming: true, videogameIds: $gameIDs}} ) { __typename nodes { __typename id name startAt endAt isOnline city addrState countryCode images { __typename url type ratio } } } }"#
    ))
