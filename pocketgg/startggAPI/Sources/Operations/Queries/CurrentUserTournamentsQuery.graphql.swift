...
public class CurrentUserTournamentsQuery: GraphQLQuery {
  public static let operationName: String = "CurrentUserTournaments"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query CurrentUserTournaments($pageNum: Int, $perPage: Int) { currentUser { __typename tournaments(query: {perPage: $perPage, page: $pageNum}) { __typename nodes { __typename id name startAt endAt isOnline city addrState countryCode images { __typename url type ratio } } } } }"#
    ))
