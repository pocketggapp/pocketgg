...
public class UserCompetingTournamentsQuery: GraphQLQuery {
  public static let operationName: String = "UserCompetingTournaments"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query UserCompetingTournaments($id: ID, $pageNum: Int, $perPage: Int) { user(id: $id) { __typename tournaments( query: {perPage: $perPage, page: $pageNum, filter: {tournamentView: "competing"}} ) { __typename nodes { __typename id name startAt endAt isOnline city addrState countryCode images { __typename url type ratio } } } } }"#
    ))
    ...
    public struct User: StartggAPI.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        ...
        .field("tournaments", Tournaments?.self, arguments: ["query": [
          ...
          "filter": ["tournamentView": "competing"]
        ]]),
      ] }
